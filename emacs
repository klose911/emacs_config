...
;;; Last modified time 
;;; Time-stamp: <klose_mow0k8a 03/22/2025 1302M02S>
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (xcscope toml-mode toml elpy yaml-mode window-numbering w3m slime session psgml markdown-mode htmlize folding cygwin-mount)))
